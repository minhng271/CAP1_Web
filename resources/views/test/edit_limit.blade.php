...
@section('content')
    ...
    <div class="content">
        <form method="POST" action="{{ url('test/limit/store_edit') }}">
            @csrf
                        ...
                        <div class="row"
                                ...
                                <div class="row">
                                    ...
                                    @foreach ($limits as $item)
                                        ...
                                        <div class="mb-3 col-md-3 d-flex flex-column">
                                            ...
                                            <input type="text" name="{{ $i }}" value="{{ $item->limit_test }}"
                                                class="form-control">
                            ...
                            <div class="row d-flex justify-content-end">
                                <button class=" col-md- btn btn-primary" style="width: 15%;height: 65%;" type="submit"
                                    ...
                                    Thay Đổi</button>
                                <a class=" col-md- btn btn-outline-secondary" href="{{ url('test/limit') }} "
