                ...
                <div class="col-md-12 d-flex">
                    <div class="card col-md-3">
                        <div class="card-body">
                            ...
                            <h1 class="mt-1 mb-3">{{$sum_count_now}}</h1>
                            <div class="mb-0">
                                <span class="@php if(($ratio_sum_count_now<0)){ echo 'text-danger'; }else echo 'text-success';@endphp">
                                <i class="mdi mdi-arrow-bottom-right"></i>
                                    @php if(($ratio_sum_count_now>0)){ echo '+'; } @endphp {{$ratio_sum_count_now}}%</span>
