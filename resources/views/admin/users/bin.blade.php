...
@section('content')
    ...
    <main class="content">
        <div class="container-fluid p-0">
            @if (session('restore'))
                    <div class="alert alert-success" style="margin-bottom: 1px">Đã khôi phục <b>{{ session('restore') }}</b> thành công</div>
                @endif
                @if (session('delete'))
                    <div class="alert alert-success "  style="margin-bottom: 1px">Xóa <b>{{ session('delete') }}</b> Khỏi danh sách thành
                        công</div>
                @endif
            <div class="row">
                                    ...
                                    @foreach ($patients as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-none d-md-table-cell" id="delete[{{ $item->id_card }}]">
                                                <a href="{{ url('admin/user/restore', ['id_card' => $item->id_card]) }}"
                                                    onclick="return confirm('KHÔI PHỤC NGƯỜI DÙNG NÀY')">
                                                    <i class="far fa-window-restore"></i>
                                                </a>
                                            </td>
                                            <td class="d-none d-md-table-cell" id="delete[{{ $item->id_card }}]">
                                                <a href="{{ url('admin/user/delete_user_bin', ['id_card' => $item->id_card]) }}"
