...
@section('content')
    <div class="profile">
        <div class="content">
            <form action="{{ url('vaccine/profile/store-edit') }}" method="POST" enctype="multipart/form-data">
                @csrf        
            <div class="profile-main">
                <div class="profile-top row">
                    <div class="profile-avatar col-md-4 d-flex justify-content-center flex-column">
                ...
                <div class="profile-bot row">
                    ...
                    <div class="col-md-8">
                        ...
                        <a class="mb-3 col-md- btn btn-outline-secondary" href="{{ url('vaccine/profile') }}">Hủy bỏ</a>
                    </div>
                </div>
            </div>
        </form>
