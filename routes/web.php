...
Route::post('/select-vac', 'VaccineController@select_delivery');
...
Route::middleware(['auth', 'is_vaccine'])->group(function () {
    ...
    Route::post('vaccine/store-them-sl-vaccine', 'VaccineController@store_vaccine_import');
    ...
    Route::get('vaccine/xet-gia-tien-benh', 'VaccineController@price_disease');
    Route::get('vaccine/price_vac_edit/{id}', 'VaccineController@price_disease_edit');
    Route::post('vaccine/price_update', 'VaccineController@price_update');
...
// https://mtacs.000webhostapp.com/
Route::get('profile/{id}', function ($id) {
    $patient =  patient::where('id_card',$id)->first();
    
    return view('information',compact('patient'));
});
